...
class TecherChatingScrean extends StatefulWidget {
  @override
  _TecherChatingScreanState createState() => _TecherChatingScreanState();
}

class _TecherChatingScreanState extends State<TecherChatingScrean> {
